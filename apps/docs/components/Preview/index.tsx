export { InputOrGroup } from "../../../../packages/core/components/InputOrGroup";

import { ReactNode, useReducer, useState } from "react";
import "../../../../packages/core/styles/global.css";
import {
  AppProvider,
  defaultAppState,
} from "../../../../packages/core/components/Puck/context";
import { PuckAction, createReducer } from "../../../../packages/core/reducer";
import { InputOrGroup } from "../../../../packages/core/components/InputOrGroup";
import {
  AppState,
  ComponentConfig,
  Config,
  Data,
} from "../../../../packages/core/types/Config";
import { rootDroppableId } from "../../../../packages/core/lib/root-droppable-id";
      ...
      render={(appState, dispatch) => (
        <div className={getClassNameConfigPreview()}>
          ...
          <div className={getClassNameConfigPreview("preview")}>
            {componentConfig.render(appState.data["content"][0].props)}
          </div>
        </div>
      )}
    />
